...
public class AllOrderListFragment extends Fragment implements View.OnClickListener  {
...
//            bundle.putString("consumerId", selectedId);
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        MenuItem item=menu.findItem(R.id.allOrders);
        if(item!=null)
