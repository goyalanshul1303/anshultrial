...
public class MyCartFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.my_cart_list, container, false);
        initViews();
    ...
    private void initViews() {
        ...
        productsRecyclerView = (RecyclerView) view.findViewById(R.id.cartRecyclerView);
        viewNoProductAdded = (View) view.findViewById(R.id.viewNoProductAdded);
        tryAgain = (Button) view.findViewById(R.id.tryAgain);
        tryAgain.setOnClickListener(this);

        new MyCartFragment.GetAllCartItemsAsyncTask().execute();

    }

    public class GetAllCartItemsAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                SpannableStringBuilder string = new SpannableStringBuilder(WebServiceConstants.GET_ALL_CART);
